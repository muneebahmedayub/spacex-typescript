...
export type LaucnhesDetailsQueryVariables = Exact<{
  id?: Maybe<Scalars['String']>;
}>;


export type LaucnhesDetailsQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
...
export const LaucnhesDetailsDocument = gql`
...
/**
 * __useLaucnhesDetailsQuery__
 *
 * To run a query within a React component, call `useLaucnhesDetailsQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaucnhesDetailsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLaucnhesDetailsQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useLaucnhesDetailsQuery(baseOptions?: Apollo.QueryHookOptions<LaucnhesDetailsQuery, LaucnhesDetailsQueryVariables>) {
        return Apollo.useQuery<LaucnhesDetailsQuery, LaucnhesDetailsQueryVariables>(LaucnhesDetailsDocument, baseOptions);
      }
export function useLaucnhesDetailsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaucnhesDetailsQuery, LaucnhesDetailsQueryVariables>) {
          return Apollo.useLazyQuery<LaucnhesDetailsQuery, LaucnhesDetailsQueryVariables>(LaucnhesDetailsDocument, baseOptions);
        }
export type LaucnhesDetailsQueryHookResult = ReturnType<typeof useLaucnhesDetailsQuery>;
export type LaucnhesDetailsLazyQueryHookResult = ReturnType<typeof useLaucnhesDetailsLazyQuery>;
export type LaucnhesDetailsQueryResult = Apollo.QueryResult<LaucnhesDetailsQuery, LaucnhesDetailsQueryVariables>;